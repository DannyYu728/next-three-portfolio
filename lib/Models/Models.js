...
export const Character = () => {
  ...
  return (
    <group ref={meshRef}>
      <primitive ref={modelRef} object={model}  scale={55}/>
    </group>
  );
}

export const Building = ({scene, scale, position, rotation, ref}) => {
...
export const SpaceShip = ({ position = [0, 0, 0], size = 1, orbit = false, rotation}) => {
